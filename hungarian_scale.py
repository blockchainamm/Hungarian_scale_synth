# Program to generate the sounds of notes of a hungarian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a hungarian scale
    notes_interval = [3, 1, 2, 1, 2, 1, 2, 2] #3 - 1 - 2 - 1 - 2 - 1 - 2 
    rev_interval = [0, 2, 1, 2, 1, 2, 1, 3]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} as root note in the hungarian scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} as root note in the hungarian scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the hungarian scale    
...
# Scale list for which the hungarian scale will be played in sequence
scale_list = ['C4']
